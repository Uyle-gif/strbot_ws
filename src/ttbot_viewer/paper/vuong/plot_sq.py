...
def main():
    ref_file = "mpc_ref_sq.csv"
    traj_file = "mpc_traj_sq.csv"
    ...
    # Trục Y (nằm ngang) trải từ 3.0 đến -13.0 (đảo ngược để chiều dương hướng sang trái, độ rộng = 16)
    ax.set_xlim(3.0, -13.0)
    
    # Trục X (thẳng đứng) trải từ -1.5 đến 14.5 (độ rộng = 16)
    ...
    ax.set_xlabel("Y (m)")
    ax.set_ylabel("X (m)")
    ax.set_title("MPC Square Trajectory Tracking Result")
